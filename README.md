...
### 🔹 Home Page  
![Home](Project_Interface/1_Home.png)

### 🔹 Contact Us (Developer)  
![Contact Us](Project_Interface/2_Contact_Us(developer).png)

### 🔹 Officials Login  
![Officials Login](Project_Interface/3_Officials_login.png)

### 🔹 Services Page  
![Services](Project_Interface/4_Services.png)

### 🔹 Data Visualization Page  
![Data Visualization](Project_Interface/5_Data_visualization_Page_.png)

### 🔹 Search Page  
![Search](Project_Interface/6_Search_.png)

### 🔹 All Student Data  
![All Student Data](Project_Interface/7_All_Student_Data.png)

### 🔹 Teacher Registration  
![Teacher Registration](Project_Interface/8_Teacher_registration.png)

### 🔹 Student Registration  
![Student Registration](Project_Interface/9_Student_registration.png)

### 🔹 OTP Verification  
![OTP Verification](Project_Interface/10_OTP_verification.png)

### 🔹 Success Page  
![Success Page](Project_Interface/11_success_page.png)

### 🔹 Student & Teacher Login  
![Student & Teacher Login](Project_Interface/12_Student_Teacher_Login.png)

### 🔹 Student Login  
![Student Login](Project_Interface/13_Student_Login.png)

### 🔹 Teacher Login  
![Teacher Login](Project_Interface/14_Teacher_Login.png)

### 🔹 Teacher Attendance (CSE)  
![Teacher Attendance](Project_Interface/15_Teacher_Attendence_CSE_.png)
